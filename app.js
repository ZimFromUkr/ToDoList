...
function display(){
    ...
    document.querySelector(".list").innerHTML += "<center><div class='element'>"+elements[i]+"<img class='tick' src='./done.png' onclick='strike("+i+")'><img class='dustbin' src='./delete.png' onclick='del("+i+")'></div></center>";
}
function del(index){
